...
import { ghostBtn, iconBtn } from '../cloud/styles';
...
const GroupDetailView: React.FC<{
  ...
  return (
    <div ref={rootRef} className="text-sm space-y-5">
      ...
      {d.editing && <EditGroupModal group={detail} onClose={() => d.setEditing(false)} />}
      ...
      <GlobalConfirmationModal
        ...
        onConfirm={() => {
          if (d.confirmUnshare) d.handleUnshare(d.confirmUnshare);
        }}
      ...
      <GlobalConfirmationModal
        ...
        onConfirm={() => {
          if (d.confirmLoad) d.openById(d.confirmLoad.ranking_id);
        }}
