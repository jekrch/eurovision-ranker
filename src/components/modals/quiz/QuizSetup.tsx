  ...
  return (
    <div className="flex flex-col gap-5 flex-1 min-h-0">
      ...
      <div className="flex flex-col min-h-0 flex-1">
        <div className="flex items-center justify-between mb-2 shrink-0">
          <label className="text-[var(--er-text-tertiary)] text-sm font-semibold">
            Years <span className="text-[var(--er-text-subtle)] font-normal">({years.length} selected)</span>
          </label>
        ...
        {sortedSelected.length === 0 && (
          <p className="text-[var(--er-error,#f87171)] text-[0.7rem] mt-1 shrink-0">Select at least one year</p>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 shrink-0">
        <div>
          <label className="text-[var(--er-text-tertiary)] text-sm font-semibold block mb-2">Difficulty</label>
          <Segmented
            value={difficulty}
        ...
        <div>
          <label className="text-[var(--er-text-tertiary)] text-sm font-semibold block mb-2">Length</label>
          <Segmented
            value={length}
            onChange={setLength}
      ...
      {/* Question types */}
      <div className="flex flex-col min-h-0 flex-1">
        <label className="text-[var(--er-text-tertiary)] text-sm font-semibold block mb-2 shrink-0">Question types</label>
        <div className="flex-1 min-h-0 overflow-y-auto rounded-lg bg-black/20 p-2 ring-1 ring-white/5">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[var(--er-text-tertiary)] text-sm font-medium">{meta.label}</span>
                </div>
                <p className="text-[var(--er-text-subtle)] text-[0.7rem] mt-0.5 ml-6">{meta.description}</p>
              </button>
            );
          })}
          </div>
        ...
        {types.length === 0 && (
          <p className="text-[var(--er-error,#f87171)] text-[0.7rem] mt-1 shrink-0">Select at least one question type</p>
        )}
      </div>
