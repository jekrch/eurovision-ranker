import { convertToCSV, convertToJSON } from './ExportUtil';
...
describe('convertToJSON', () => {
  it('converts country contestants to JSON format', async () => {
    ...
    expect(jsonString).toBe(
      '[{"rank":"1","countryName":"country1","countryKey":"ab","artist":"artist1","song":"song1","youtube":"https://www.youtube.com/watch?v=video1","totalVotes":"0"},{"rank":"2","countryName":"country2","countryKey":"cd","artist":"artist1","song":"song1","youtube":"","totalVotes":"0"}]',
    );
  });
});
