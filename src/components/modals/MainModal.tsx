            ...
            <div className="overflow-y-auto pt-4 select-text pb-3 flex-grow">
                {activeTab === 'about' &&
                    <div className="">
                        ...
                        <p className="mt-4">Thanks also to Janne Spijkervet, John Ashley Burgoyne, and David John Baker, who have compiled a massive dataset from Eurovisionworld's site, which I have used in this project. Their work is available on <a className="text-link" href="https://github.com/Spijkervet/eurovision-dataset">github</a>.</p>
